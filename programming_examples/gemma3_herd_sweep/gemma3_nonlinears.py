...
def nonlinear_registry(config: Gemma3TextConfig | None = None) -> tuple[Gemma3NonlinearSpec, ...]:
    ...
    return (
        ...
        Gemma3NonlinearSpec(
            operation="rope",
            model_status="standalone-npu-reuse-candidate",
            implementation_path="programming_examples/gemma3_dataflow_kernels/rope_halfsplit.py",
            compile_lit="programming_examples/gemma3_dataflow_kernels/run_rope_halfsplit_compile_only.lit",
        ...
        Gemma3NonlinearSpec(
            ...
            model_status="standalone-npu-reuse-candidate",
            implementation_path="programming_examples/gemma3_dataflow_kernels/residual_add.py",
            compile_lit="programming_examples/gemma3_dataflow_kernels/run_residual_add_compile_only.lit",
