...
- `gemma3_reproduction_blockers.py` reports Phase F as `BLOCKED` because
  ...
  over-allocates tile memory for this shape, and because paper 1k KV attention,
  logits/sampling, and the production contiguous static-weight BO route remain
  open. The real 1B blocker report now narrows the launch
