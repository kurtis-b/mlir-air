...
`gemma3_norm_weight_plan.py`. It is preload evidence only; model kernel argument
...
from gemma3_norm_weight_plan import Gemma3NormWeightRecord, build_norm_weight_plan


DEFAULT_NORM_PRELOAD_EVIDENCE = Path(__file__).with_name("results") / "gemma3_norm_preload_evidence.json"
