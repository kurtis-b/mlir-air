...
from gemma3.npu.weight_plan import Gemma3ProjectionWeightRecord, build_weight_plan
from gemma3.paths import RESULTS_DIR


DEFAULT_STATIC_PRELOAD_EVIDENCE = RESULTS_DIR / "gemma3_static_preload_evidence.json"
