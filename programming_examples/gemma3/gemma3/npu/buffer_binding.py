...
is handled by gemma3.npu.argument_binding; launch execution remains separate.
"""
...
from gemma3.npu.wiring import Gemma3NPUStage, Gemma3NPUWiringPlan, build_wiring_plan_from_preflight
