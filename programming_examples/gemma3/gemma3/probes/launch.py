...
from gemma3.paths import REPO_ROOT, RESULTS_DIR
...
DEFAULT_LAUNCH_PROBE_EVIDENCE = RESULTS_DIR / "gemma3_1b_first_kernel_launch_probe.json"
...
def _first_stage_argument_binding_evidence(
    *,
    ...
    binding = None
    try:
        from gemma3.npu.argument_binding import build_argument_binding_plan
    except Exception as exc:
...
"""
    result = _result_from_completed_process(
        ...
        bo_binding_mode="runner-owned-persistent-bo",
        remaining_model_runner_gaps=("substep-sequence-not-wired", "full-layer-not-wired"),
        command=("python3", "-m", "gemma3.probes.launch"),
        returncode=0,
