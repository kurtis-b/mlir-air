...
from gemma3.core.common import Q4NX_COLS, Q4NX_ROWS, parse_herd_shape, resolve_output_mode
        ...
        for layer in self.layers:
            steps.extend(
                [
                    ...
                    Gemma3KernelStep("prefill", layer.layer_index, "mlp_activation", "n/a", "host-fallback", "gemma3.kernels.geglu candidate"),
                    ...
                    Gemma3KernelStep("decode", layer.layer_index, "mlp_activation", "n/a", "host-fallback", "gemma3.kernels.geglu candidate"),
                ]
            )
        return tuple(steps)
