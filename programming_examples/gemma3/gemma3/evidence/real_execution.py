...
from gemma3.core.artifacts import MODEL_SPECS, Gemma3ArtifactError, load_real_model_artifacts
...
def run_torch_benchmark(
    *,
    ...
    if quantized_weights == "required":
        from gemma3.core.quantized_weights import ensure_q4nx_cache, manifest_path_for
