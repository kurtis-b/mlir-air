...
def build_rms_qkv_bias_rope_module(
    ...
    # `with_tile_n`, not a bare `spec["tile_n"] = 128`: the object name and symbol
    # suffix are functions of tile_n since Phase E1, so retiling has to re-mint
    # them or the module asks for an `mm_*.o` nobody compiles.
    if q_pad != q_dim:
