...
| **Llama-3.2-1B int4-AWQ** | `amd/Llama-3.2-1B-Instruct-awq-...` | 16 | 2048 / 64 / 8192 | GQA 32Q/8KV | int4-AWQ (bf16 prefill on dequantized AWQ + int4 NPU decode) | prefill + decode (`make run-inference`; decode 14.67 tok/s at ctx 512, 08-26 Turbo recorded, devq 610 -- the June ~17.8 was pmode-unrecorded with no artifact) |
