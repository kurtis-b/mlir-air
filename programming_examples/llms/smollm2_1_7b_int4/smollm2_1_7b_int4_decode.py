...
def compile_decode_kernels(cache, config):
    ...
    # backend kwargs -- the first build without it linked the gs=128 default
    # (devq 372/376) because that sweep restaged the canonical right before
    # the link, after every explicit staging here had run.
