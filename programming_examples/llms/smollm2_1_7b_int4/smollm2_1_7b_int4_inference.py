...
def build_session(args) -> Session:
    ...
    print(f"\nLoading GGUF q4_0 weights ({args.gguf})...")
    weights = load_weights_gguf_q4_0(args.gguf, HF_MODEL, config=config)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--gguf", type=str, default=DEFAULT_GGUF)
