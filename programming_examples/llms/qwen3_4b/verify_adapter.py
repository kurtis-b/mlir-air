...
"""Verify adapter for the bf16 Qwen3-4B example.

Wraps the production `qwen3_4b_inference` driver into a Runner that
satisfies `verify/runners/base.Runner`. The shared verify framework
imports this via `--runner=qwen3_4b.verify_adapter`.

Qwen3-4B has no separate "-Instruct" repo (Qwen3 unifies base and
instruct), so both MODEL_CHOICES keys map to "Qwen/Qwen3-4B".
"""
...
from qwen3_4b_prefill import (  # noqa: E402
    compile_all_kernels as compile_prefill_kernels,
    run_transformer_block_qwen3 as run_prefill_block,
)
from qwen3_4b_decode import compile_decode_kernels  # noqa: E402
from qwen3_4b_inference import (  # noqa: E402
    prepare_runtime,
    run_npu_prefill,
    run_npu_decode_step,
)
from qwen3_4b_weights import (  # noqa: E402
    LlamaConfig,
    load_weights,
    generate_rope_lut,
)
from qwen3_4b_cpu_helpers import rms_norm  # noqa: E402
