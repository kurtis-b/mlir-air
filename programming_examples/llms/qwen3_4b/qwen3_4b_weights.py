...
Loads Qwen3-4B weights from HuggingFace safetensors into numpy arrays for
...
@dataclass
class LlamaConfig:
    """Qwen3-4B hyperparameters (named LlamaConfig for downstream reuse)."""
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Load Qwen3-4B weights, print shapes")
