...
| 2048×2048 | 128/128 | 16/8 | ✓ | 2 | 17.6 ms | 979 | 3.8e-2 | 7.1e-2 | ✅ Qwen3-0.6B + Qwen3-1.7B prefill (head_dim=128, 16q/8kv — identical FA config; re-PASSED on Qwen3-1.7B run) |
| 2048×2048 | 64/64 | 14/2 | ✓ | 1 | 7.27 ms | 1035 | 3.8e-2 | 7.0e-2 | ✅ Qwen2.5-0.5B prefill (head_dim=64, 2 KV heads) |
| 2048×2048 | 128/128 | 12/2 | ✓ | 2 | 14.5 ms | 891 | 3.8e-2 | 7.0e-2 | ✅ Qwen2.5-1.5B prefill (head_dim=128, 12q/2kv GQA) |
| 2048×2048 | 128/128 | 16/2 | ✓ | 2 | 19.1 ms | 899 | 3.8e-2 | 8.7e-2 | ✅ coverage (head_dim=128, 16q/2kv GQA) |
