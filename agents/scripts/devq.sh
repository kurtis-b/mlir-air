...
DEVQ_DIR=${DEVQ_DIR:-/home/cj/mlir-air/agents/.state/devq}
...
TLENV=${TLENV:-/home/cj/.claude/jobs/e75c34c9/tmp/tlenv.sh}
...
cd /home/cj/mlir-air || { echo "== FATAL: cd /home/cj/mlir-air failed"; exit 1; }

R=${R:-/home/cj/mlir-air/programming_examples/transformer_layer/results/CHANGEME}
