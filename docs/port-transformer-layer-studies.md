...
| E `llms/` + kernels | 14,477 | 7,233 | 6,236 | 412 | 21,298 | verify_runner host tests (this PR, 412 after its review fixes); next: shared decode_qkv4 + test, then the qwen3 / llama32_1b_int4 / smollm2 int4 model rows, int4_awq q4_0, registry rows (data, ≈11 PRs) |
