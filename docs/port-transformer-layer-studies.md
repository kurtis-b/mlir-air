...
| F compiler | 1,942 | 6,099 | 2,831 | 885 | 7,156 | H10 (#7, 290); shared-L1 put guard (#9, 155); shrink-memref extent (this PR, 440); prepared: H3 verifier, split-l2 B |
...
| **total** | **17,436** | **13,361** | **94,437** | **1,724** | **29,073** | 35 PRs include-only; 62 at full refactor size |
