...
| F compiler | 1,942 | 6,099 | 2,831 | 1,745 | 6,296 | H10 (#7, 290); shared-L1 put guard (#9, 155); shrink-memref extent (#10, 440); H3 attribute verifier (#11, 123); split-l2 short offsets (#12, 438); split-l2 repeated feed (this PR, 299); prepared: split-l2 C |
...
| **total** | **17,436** | **13,361** | **94,437** | **2,584** | **28,213** | 35 PRs include-only; 62 at full refactor size |
