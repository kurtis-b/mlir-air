...
| F compiler | 1,942 | 6,099 | 2,831 | 2,277 | 5,764 | H10 (#7, 290); shared-L1 put guard (#9, 155); shrink-memref extent (#10, 440); H3 attribute verifier (#11, 123); split-l2 short offsets (#12, 438); split-l2 repeated feed (#13, 373 after its review fixes); split-l2 far-side pairing (this PR, 458) |
...
| **total** | **17,436** | **13,361** | **94,437** | **3,923** | **26,874** | 35 PRs include-only; 62 at full refactor size |
