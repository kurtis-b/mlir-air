...
|---|---:|---:|---:|---:|---:|---|
| B `agents/` | 1,017 | 0 | 3,194 (+1,397 already on main) | 0 | 1,017 | #B1 devq core (this PR), B2 new-job + selftest, B3 audit script |
...
| **total** | **17,436** | **13,361** | **94,437** | **0** | **30,797** | 35 PRs include-only; 62 at full refactor size |
