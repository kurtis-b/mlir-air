...
| Artifact | Lines | Disposition | Notes |
|---|---|---|---|
| `pattern/reference.py` | 172 | PORT | Pure torch golden model, `encoder_bert` + `decoder_gpt2`. The correctness anchor for all four modes. |
...
| `hybrid/op.py` | 709 | REWRITE | 12 runlist entries over 5-6 coarse kernels. Renamed `coarse` — convention rule 7. |
