...
| [25-first-study-result-sequence-ladder.md](25-first-study-result-sequence-ladder.md) | **The first study RESULT rather than a capability.** Four modes across four sequence lengths, twice: a `fused`/`coarse` crossover between 2048 and 4096, and slopes that split on attention placement |
