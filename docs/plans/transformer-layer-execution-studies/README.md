...
| 9 | ~~**R1** — the supertile first increment~~ **done 2026-08-22** — ported iron's partial-sum-staging pipeline; runs at the layer's width; 26.39 ms vs `coarse`'s tail 4.66 ms (band-serial weight re-streaming); [31 §2.3](31-resident-tail-r1-record.md) | done |
