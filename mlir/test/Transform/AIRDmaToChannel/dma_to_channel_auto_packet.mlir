...
// Per-column shim DMA limit = 2. Since 4 > 2, three input channels are
// upgraded to dma_packet, leaving one stream slot and one packet slot.
// Output channels (2 total) do not exceed the per-column limit.
