//===- ping_pong_shared_resident_ring_mixed_annotated.mlir -----*- MLIR -*-===//
//
...
// ping_pong_shared_resident_ring_mixed.mlir, which keeps the same input with
// an UNANNOTATED callee and asserts the Skip.
