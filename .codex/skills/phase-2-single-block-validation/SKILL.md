...
`<model>/multi_launch_builder/`, using the shared infra
...
argument mismatch lives. Use the systematic-debugging fallback: capture a minimal repro, bisect the last relevant change, isolate the failing layer or kernel, and document the blocker in the model TODO on it.
